...
export default function NotificationsgtTemplatesPage() {
  return (
    <div className="max-w-6xl mx-auto animate-in fade-in duration-300 w-full">
      <header className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight">Notifications &gt; Templates</h1>
          <p className="text-slate-400 mt-2 text-sm">Manage and configure notifications &gt; templates.</p>
        </div>
