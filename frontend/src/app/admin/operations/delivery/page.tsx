...
export default function OperationsgtDeliveryPage() {
  return (
    <div className="max-w-6xl mx-auto animate-in fade-in duration-300 w-full">
      <header className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight">Operations &gt; Delivery</h1>
          <p className="text-slate-400 mt-2 text-sm">Manage and configure operations &gt; delivery.</p>
        </div>
