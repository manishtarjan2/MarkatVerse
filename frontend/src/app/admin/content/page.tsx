  ...
  return (
    <div className="max-w-6xl mx-auto w-full animate-in fade-in duration-300">
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-white tracking-tight capitalize">Content Management</h1>
        <p className="text-slate-400 mt-2 text-sm">Manage and configure content across the platform.</p>
      </header>
      ...
      <div className="bg-slate-800 rounded-2xl border border-slate-700 shadow-lg p-12 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-slate-400 max-w-md mx-auto">
          The Content module is currently being migrated to use live API data. 
          Check back soon.
        </p>
      </div>
    </div>
